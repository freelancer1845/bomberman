...
public class ObjectFactory {
     ...
     * @param id of the powerup
     * @param addImmediately Immediately if true the object is added to the World immediately. If
     *        false it is added to the ObjectRegistry Queue and null is returned.
     * @return the {@link Body} object
     */
    public Body createPowerUp(int xGridPosition, int yGridPosition, String id,
        ...
        if (addImmediately) {
            ...
            ObjectRegistry.getInstance().queueObjectForCreation(bodyDef, fixtureDef, id);
            return null;
        }
    }
